...
## Program 8c(insertEmployee)
  ...
  - **employee** -(https://github.com/Rakshitha-Kotyan/Java_Programs/blob/main/employee.sql)
...
## Program 9a(delete)
  - **delete** -(https://github.com/Rakshitha-Kotyan/Java_Programs/blob/main/delete.jsp)
